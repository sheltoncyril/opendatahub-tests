...
from tests.ai_hub.model_catalog.constants import VALIDATED_CATALOG_ID, REDHAT_AI_CATALOG_ID
...
from tests.ai_hub.utils import get_model_catalog_pod, execute_get_command
