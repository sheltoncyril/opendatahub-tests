...
```bash
pytest tests/ai_safety/nemo_guardrails/ -v
```

### Run Specific Test Class

```bash
pytest tests/ai_safety/nemo_guardrails/test_nemo_guardrails.py::TestNemoGuardrailsLLMAsJudge -v
```

### Run Specific Test

```bash
pytest tests/ai_safety/nemo_guardrails/test_nemo_guardrails.py::TestNemoGuardrailsLLMAsJudge::test_nemo_llm_judge_deployment -v
```

### Run Config Update Tests

```bash
pytest tests/ai_safety/nemo_guardrails/test_config_update.py -v
```
...
```bash
# Smoke tests only
pytest tests/ai_safety/nemo_guardrails/ -m smoke -v

# Tier1 tests
pytest tests/ai_safety/nemo_guardrails/ -m tier1 -v

# Tier2 tests
pytest tests/ai_safety/nemo_guardrails/ -m tier2 -v
```
