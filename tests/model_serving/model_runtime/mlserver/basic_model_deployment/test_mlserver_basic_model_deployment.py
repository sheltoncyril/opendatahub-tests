...
class TestMLServerModels:
    ...
    def test_mlserver_model_inference(
        ...
        """
        Test model inference using MLServer across different protocols and deployment types.
        ...
        Args:
            ...
            model_format (str): Identifier for the model framework (e.g., "sklearn", "onnx").
        """
        ...
        query_key = f"{protocol.lower()}_query"
