# Temporarily adding this file here till https://github.com/RedHatQE/openshift-python-wrapper/pull/2564 is merged
# and new release is available
...
class Authentication(Resource):
    ...
    Compatibility level 1: Stable within a major release for a minimum of 12 months or 3 minor releases
    (whichever is longer).
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            webhook_token_authenticator (dict[str, Any]): webhookTokenAuthenticator configures a remote token reviewer.
            ...
            webhook_token_authenticators (list[Any]): webhookTokenAuthenticators is DEPRECATED, setting it has no
               effect.
